            ...
            <aside class="sidebar">
                <div class="filter-group">
                    ...
                    <ul class="list-catalog">
                        <li>
                            <a href="search-product?search=${fn:escapeXml(keyword)}&cid=0&sort=${currentSort}&minPrice=${currentMin}&maxPrice=${currentMax}&page=1"
                               class="catalog-item ${currentCid == 0 ? 'active' : ''}">
                                Tất cả danh mục
                            </a>
                        </li>
                        ...
                        <c:forEach items="${listCategories}" var="c">
                            <li>
                                <a href="search-product?search=${fn:escapeXml(keyword)}&cid=${c.id}&sort=${currentSort}&minPrice=${currentMin}&maxPrice=${currentMax}&page=1"
                                   class="catalog-item ${currentCid == c.id ? 'active' : ''}">
                                        ${c.name}
                                </a>
                            </li>
                        </c:forEach>
